...
const uploadFile = require("../Controller/User/UserAvatarUpload");
...
//  routes 
user.post("/" , uploadFile , Uservalidetion , uservalidetionResult , UserSignUp)
...
user.put("/", CheckUser , uploadFile  , UserUpdatedInfoValidetion , UpdateInfoValidetionResult , UserUpdate)
user.get("/singel/:id", Singeluser)
user.delete("/logout",CheckUser,LogoutUser);
